<template>
  <header class="sticky top-0 h-16 backdrop-filter backdrop-blur-lg">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <a class="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
        ...
        <span class="ml-3 text-xl">LongiBigage</span>
      </a>
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2021 LongiBigage.io —
      <a href="https://twitter.com/longibigage" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@longibigage</a>
    </p>
